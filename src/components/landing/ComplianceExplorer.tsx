...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Responses cite model building codes, local amendments, and plan notes',
    ...
    visual: 'rfi',
    aside: [
      { label: 'Sources', value: 'IBC · Local · Plans' },
  ...
  },
  {
    ...
    visual: 'osha',
    aside: [
      { label: 'Standard', value: 'OSHA Title 29' },
  ...
  },
  {
    id: 'title24',
    title: 'Energy code',
    titleFull: 'National model energy standards',
    summary: 'Energy-code conditions at each phase.',
    bullets: [
      'Envelope, HVAC, and lighting specs checked against model energy code at each step',
    ...
    visual: 'energy',
    aside: [
      { label: 'Scope', value: 'Envelope · PV · HVAC' },
      { label: 'Trigger', value: 'Every build phase' },
      { label: 'Deliverable', value: 'Energy compliance packet' },
    ],
  },
  {
    id: 'ceqa',
    title: 'Environmental review',
    titleFull: 'NEPA-style site impact review',
    ...
    visual: 'ceqa',
    aside: [
      { label: 'Review', value: 'Initial study · EA' },
  ...
  },
  {
    ...
    titleFull: 'State & local authority inspections',
    ...
    bullets: [
      ...
      'Required submittals queued before each authority field visit',
    ...
    visual: 'dsa',
    aside: [
      { label: 'Jurisdiction', value: 'Local AHJ · Field ops' },
